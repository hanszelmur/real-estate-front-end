    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">TES Properties</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted partner in real estate. We help you find your dream property with
              professional service and expert guidance every step of the way.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} TES Properties. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
